<%-- 
    Document   : PAListadeUsuarios
    Created on : 26/11/2017, 02:48:58 PM
    Author     : diego
--%>
...
<html>
    ...
    <body onpaste="return false" ondrag="return false" ondrop="return false;">
        ...
        <div class="act">
            <p class="decofal">Lista de Usuarios</p>
            <p class="elpapu">Checa la cantidad de Usuarios que hay en el Sitio</p>
        </div>
        <div class="trp">
            <br><br>
        <form name="FormElimUsu" method="post" action="eliminar.jsp">
        <label name="lblBuscaUsus" class="elamor">Introduce el Nombre de un Usuario:</label>
        <br>
        <input type="text" name="buscarUsuarios" id="buscaUsuarios" class="buscaUsus" placeholder="Usuario"> <input type="submit" value="Eliminar Usuario" class="usu">
        </form>
             <br><br>
           <iframe src="mostrarUsu.jsp" height="320px" width="800px"  frameborder="0" scrolling="yes" name="Ventanas"></iframe>
        </div>
    </body>
</html>
