<%-- 
    Document   : PasoCuatroDos
    Created on : 8/05/2018, 09:39:11 PM
    Author     : diego
--%>
...
%>
                    ...
                    <br><br><br><br>
                    <p class="lbl">Una vez selecionada la imagen regresaras al menu para iniciar sesion.</p>
                    <br>
                    <form action="run.jsp" method="post" name="Regdos" target="_parent">
